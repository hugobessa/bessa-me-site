      ...
      <div className="px-2">
        ...
        <div className="space-y-8">
          {educationHistoryData?.map((education, index) => (
            ...
            >
              <span className="flex items-center mr-4 mb-4 justify-center w-20 min-w-[5rem] h-20 bg-white border-8 border-white dark:border-gray-900 dark:bg-blue-900">
                <Image
                  className="rounded"
                  width={64}
                  height={64}
              ...
              <div className="rounded-lg mb-4 w-auto grow">
