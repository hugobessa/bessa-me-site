...
const languagesData: Language[] = [
  ...
  { name: "English", level: "Fluent. I speak and write daily." },
  {
    name: "Spanish",
    level:
      "Basic. I can listen and read, but have difficulty in speaking and writing.",
  },
];
...
const tags = [
  ...Array.from(new Set(contentData.map((item) => item.tags).flat())),
];
    ...
    <div className={mobileMenuOpen ? "max-h-screen overflow-hidden" : ""}>
            ...
            <div className="flex-1 flex items-center justify-between sm:items-stretch">
              ...
              <div className="hidden sm:block sm:ml-6 float-right">
                <div className="flex space-x-4">
                  ...
                  <a
                    href="#work"
                    className="text-orange-500 hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium"
                  >
                    Work
                  </a>
                  <a
      ...
      >
        <div className="container mx-auto md:w-2/3 px-2 py-12 max-h-800 pt-20">
          <div className="flex items-center justify-between">
            ...
            <div className="w-1/2">
              <h1 className="text-4xl pl-4">
                Hi, I'm <span className="font-bold">Hugo Bessa</span>
              </h1>
              <p className="text-lg pl-4">
                Expert in building MVPs and scaling them. Amateur
                composer/producer in the free time
              </p>
            </div>
          </div>
        </div>
                  ...
                  {educationData.map((education, index) => (
                    ...
                    >
                      ...
                      <div className="p-4 bg-white rounded-lg grow border border-gray-200 dark:bg-gray-700">
                        ...
                        <div className="text-sm font-normal text-gray-500 dark:text-gray-300">
                          <a
                            href={education.institution.link}
                            className="font-semibold text-orange-600 dark:text-blue-500 hover:underline"
                          >
      ...
      <section id="content" className="py-12 bg-orange-200 relative">
        <div
          ...
          style={{
            backgroundImage: `url(${chevronPatternSvg.src})`,
